...
const DEFAULT_CONFIGURATIONS: ExperimentConfiguration[] = [
  { name: "Small chunks (256 / 32)", chunkSize: 256, chunkOverlap: 32, matchCount: 3 },
  { name: "Medium chunks (512 / 50)", chunkSize: 512, chunkOverlap: 50, matchCount: 3 },
  ...
  { name: "Large chunks (1024 / 100)", chunkSize: 1024, chunkOverlap: 100, matchCount: 3 },
];
...
async function processDocument(
  ...
  for (const query of queries) {
    ...
    // Parity fix: mirrors production pgvector params — threshold 0.2, top-k 3.
